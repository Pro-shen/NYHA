  ...
  <div class="app-container">
    ...
    <el-row :gutter="10" class="mb8">
      <!-- <el-col :span="1.5">
        <el-button type="primary" plain icon="el-icon-plus" size="mini" @click="handleAdd"
          v-hasPermi="['nyha:tVisitApproval:add']">新增</el-button>
      </el-col> -->
      <el-col :span="1.5">
        <el-button type="success" plain icon="el-icon-edit" size="mini" :disabled="single" @click="handleUpdate"
          v-hasPermi="['nyha:tVisitApproval:edit']">诊断</el-button>
      </el-col>
      <!-- <el-col :span="1.5">
        <el-button type="danger" plain icon="el-icon-delete" size="mini" :disabled="multiple" @click="handleDelete"
          v-hasPermi="['nyha:tVisitApproval:remove']">删除</el-button>
      </el-col> -->
      <el-col :span="1.5">
        <el-button type="warning" plain icon="el-icon-download" size="mini" @click="handleExport"
          v-hasPermi="['nyha:tVisitApproval:export']">导出</el-button>
      </el-col>
    ...
    <el-table v-if="refreshTable" v-loading="loading" :data="tVisitList" row-key="id" :default-expand-all="isExpandAll"
      ...
      <el-table-column label="操作" align="center" class-name="small-padding fixed-width">
        <template slot-scope="scope">
          <el-button size="mini" type="text" icon="el-icon-edit" @click="detailInfo(scope.row)"
            v-hasPermi="['nyha:tVisitApproval:list']">查看详情</el-button>
          <el-button size="mini" type="text" icon="el-icon-edit" @click="handleUpdate(scope.row)"
            v-hasPermi="['nyha:tVisitApproval:edit']">诊断</el-button>
          <!-- <el-button v-if="scope.row.parentId != 0" size="mini" type="text" icon="el-icon-delete"
            @click="handleDelete(scope.row)" v-hasPermi="['nyha:tVisitApproval:remove']">删除</el-button> -->
        </template>
      </el-table-column>
    </el-table>
    ...
    <!-- 查看菜单配置对话框 -->
    <el-dialog title="请求详情" :visible.sync="detailsOpen" width="500px" append-to-body>
      <div slot="footer" class="dialog-footer">
        <el-form ref="form" :model="form" :rules="rules" label-width="100px">
          <el-form-item label="姓名">
            {{ detailsForm.patientName }}
          </el-form-item>
          <el-form-item label="请求时间">
            {{ detailsForm.createTime }}
          </el-form-item>
          <el-form-item label="症状体征">
            {{ detailsForm.symptoms }}
          </el-form-item>
          <el-form-item label="心理状态">
            {{ detailsForm.psychology }}
          </el-form-item>
          <el-form-item label="生活方式">
            {{ detailsForm.lifeStyle }}
          </el-form-item>
          <el-form-item label="用药依从性">
            {{ detailsForm.compliance }}
          </el-form-item>
          <el-form-item label="有无诱因">
            {{ detailsForm.incentive }}
          </el-form-item>
          <el-form-item label="就诊结果">
            {{ detailsForm.results }}
          </el-form-item>
          <el-form-item label="NYHA评估">
            {{ detailsForm.nyha }}
          </el-form-item>
        </el-form>
        <el-button type="primary" @click="detailsSubmitForm">确 定</el-button>
      </div>
    </el-dialog>
...
<script>
import { list, getUserId, add, selectTVisitListById, edit, remove } from "@/api/nyha/tVisitApproval"
...
export default {
  ...
  methods: {
    ...
    handleExport() {
      this.download('/nyha/tVisitApproval/export', {
        ...this.queryParams
