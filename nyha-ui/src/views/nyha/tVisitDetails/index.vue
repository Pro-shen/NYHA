    ...
    <el-row :gutter="10" class="mb8">
      <!-- <el-col :span="1.5">
        <el-button type="primary" plain icon="el-icon-plus" size="mini" @click="handleAdd"
          v-hasPermi="['nyha:tVisitDetail:add']">新增</el-button>
      </el-col> -->
      <!-- <el-col :span="1.5">
        <el-button type="success" plain icon="el-icon-edit" size="mini" :disabled="single" @click="handleUpdate"
          v-hasPermi="['nyha:tVisitDetail:edit']">修改</el-button>
      </el-col> -->
      <!-- <el-col :span="1.5">
        <el-button type="danger" plain icon="el-icon-delete" size="mini" :disabled="multiple" @click="handleDelete"
          v-hasPermi="['nyha:tVisitDetail:remove']">删除</el-button>
      </el-col> -->
      <el-col :span="1.5">
        <el-button type="warning" plain icon="el-icon-download" size="mini" @click="handleExport"
          v-hasPermi="['nyha:tVisitDetail:export']">导出</el-button>
      </el-col>
      ...
      <el-table-column label="操作" align="center" class-name="small-padding fixed-width">
        <template slot-scope="scope">
          <el-button size="mini" type="text" icon="el-icon-edit" @click="detailInfo(scope.row)"
            v-hasPermi="['nyha:tVisitDetail:list']">查看详情</el-button>
...
<script>
import { list, getUserId, add, selectTVisitListById, edit, remove } from "@/api/nyha/tVisitDetails"
...
export default {
  ...
  methods: {
    ...
    handleExport() {
      this.download('/nyha/tVisitDetails/export', {
        ...this.queryParams
