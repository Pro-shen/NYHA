...
@RestController
@RequestMapping("/nyha/tFollowDetails")
public class TFollowDetailsController extends BaseController {

    @Autowired
    private ITFollowDetailsService itFollowDetailsService;
    ...
    public TableDataInfo list(TFollow tFollow){
        startPage();
        List<TFollow> tFollows = itFollowDetailsService.list(tFollow);
    ...
    public AjaxResult getUserId(@PathVariable("userName") String userName){
        ...
        ajaxResult.put("data",itFollowDetailsService.getUserId(userName));
        return ajaxResult;
    }
    ...
    public AjaxResult add(@Validated @RequestBody TFollow tFollow){
        ...
        ajax.put("data",itFollowDetailsService.add(tFollow));
        return ajax;
    }
    ...
    public AjaxResult selectTFollowListById(@PathVariable("id") Long id){
        ...
        ajax.put("data",itFollowDetailsService.selectTVisitListById(id));
        return ajax;
    }
    ...
    public AjaxResult edit(@RequestBody TFollow tFollow){
        AjaxResult ajax = AjaxResult.success();
        ajax.put("data",itFollowDetailsService.edit(tFollow));
        return ajax;
    }
    ...
    public AjaxResult remove(@RequestBody TFollow tFollow){
        AjaxResult ajax = AjaxResult.success();
        ajax.put("data",itFollowDetailsService.remove(tFollow));
        return ajax;
    }
    ...
    {
        List<TFollow> list = itFollowDetailsService.list(tFollow);
